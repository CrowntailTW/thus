...
Partial Class CutInfo
    ...
    Public Sub update_mileage()
        ...
        For i = 0 To 14
            ...
            Xlabel(i)(1) = ""
            data(0)(i) = 0 ' tb.Rows(0).Item("U_mileage") '上刀輪mileage
            data(1)(i) = 0 'tb.Rows(0).Item("L_mileage") '下刀輪mileage
        ...
        cstext.Append(mycls.toJStext_new("canvasX", _
                                          ...
                                          yaxis, _
                                          False))
        mycls.cstext2Canvas(Page, cstext, "canvasX", Table1)
        ''''''Dim cell As New TableCell
        ''''''Dim li As New Literal
        ''''''li.Text = " <canvas id=" & Chr(34) & "canvasX" & Chr(34) & " style=" & Chr(34) & "width:900px;height:400px" & Chr(34) & "></canvas>"
    ...
    Public Sub update_pressure()
        ...
        For i = 0 To 14
                ...
                If tb.Rows.Count > 0 Then
                    ...
                    For j = 0 To 3
                        ...
                        For k = 0 To 19
                            'PresureAX1
                            If j Mod 2 = 0 Then
                                data(j)(19 - k) = Convert.ToDouble(tb.Rows(0).Item("Presure" & cut(j) & k + 1) * IIf(j \ 2 = 0, 1, -1))
                            Else
                                data(j)(k + 20) = Convert.ToDouble(tb.Rows(0).Item("Presure" & cut(j) & k + 1) * IIf(j \ 2 = 0, 1, -1))
                            End If
                    ...
                    updateTime = tb.Rows(0).Item("TimeA")
                End If
                ds.Reset()
                tb.Reset()
            End If
            ...
            cstext.Append(mycls.toJStext_new("canvasX" & i + 1, _
                                          "Cut Cutter Pressure CCT#" & num2eqp(i + 1) & "  - " & updateTime, _
                                          Xlabel, _
                                          chartType, _
                                          Datalabels, _
                                          data, _
            ...
            '''Dim cell As New TableCell
            '''Dim li As New Literal
            '''li.Text = " <canvas id=" & Chr(34) & "canvasX" & i + 1 & Chr(34) & " style=" & Chr(34) & "width:900px;height:400px" & Chr(34) & "></canvas>"
            '''cell.Controls.Add(li)
            '''Dim row As New TableRow
            '''row.Cells.Add(cell)
            '''row.Height = 400
    ...
    ''''''                        Optional ratio_max As Integer = 35) As String
