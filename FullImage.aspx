<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FullImage.aspx.vb" Inherits="FullImage" %>
                ...
                <tr align="center">
                    ...
                    <td style="align-content: center; width: 5em; vertical-align: middle">
                        <div style="width: 20em; height: 100%">
                            <asp:Button ID="Button1" runat="server" Text="Submit" Height="4em" width= "20em" TabIndex='0' />
                            <br/>
                            <asp:Button ID="Button_Download" runat="server" Text="Download" Height="4em" width= "20em" TabIndex='1' />
                            <br/>
                            <asp:Button ID="Button3" runat="server" Height="4em" width= "20em" Text="Button" />
                        </div>
                    </td>
                </tr>
